...
public class Constants {
    public static final String DATABASE_NAME = "checklistdatabase"; // database name
    public static final String CHECKLIST_TABLE_NAME = "CHECKLISTTABLE"; // checklist table name
    public static final String TODO_TABLE_NAME = "TODOTABLE"; // to do table name
    public static final String UID = "_id"; // unique id
    public static final String USERNAME = "Username"; // username
    public static final String CHECKLISTNAME = "ChecklistName"; // checklist name
    public static final String DESCRIPTION = "Description"; // checklist description
